function [ EQ, Q_history, runtime_history, success_history] = mcmc( y, Q_0, P, N, alpha, T, varargin )
...
for iteration = 2:nIterations
	%do one sample
	tic
	[Q_history{iteration}, success_history(iteration)] = gibbsSample(y, Q_history{iteration - 1}, P, N, alpha, T, moves, useARS);
	runtime_history(iteration) = toc;
end
...
function [ Q_prime, success ] = gibbsSample( y, Q, P, N, alpha, T, moves, useARS )
