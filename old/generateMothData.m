function [ y, q, n, p ] = generateMothData( N, mu, sigma, lambda, alpha, t )
%GENERATEMOTHDATA Generate a sample of transect counts given dist'n params
%   Inputs:
...
q = sample_hist(reshape(p,1,numel(p)),N);
q = reshape(q, T+1, T+1);
