...
%    'observLineStyle'    = style of vertical time lines
...
addParamValue(parser, 'observLineStyle',    DEFAULT_OBSERV_LINE_STYLE);
...
observLineStyle    = parser.Results.observLineStyle;
...
if ~isempty(T)
	plot([T;T], repmat(ylim, K, 1)', ...
		 observLineStyle, 'LineWidth', observLineWidth, 'Color', observLineColor)
